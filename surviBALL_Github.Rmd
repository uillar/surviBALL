...
We will filter each cohort independently to take those lncRNAs minimally expressed in both cohorts. First we do it on NGS data:
...
Now, we prepare the survival/clinical colData for each cohort. First for NGS:
...
This result shows that C2 cohort's global expression is signifiC2tly higher than the NGS cohort's. No t exprected, as much more lncRNAs were filters with the minnimum expression criteria in C2 cohort...
